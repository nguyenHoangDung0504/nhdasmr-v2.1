...
/*WATCH VIEWS*/{
  document.querySelector('.container .vid_div').innerHTML = window.watchView.vidDivContent;
  document.querySelector('.container .content_div').innerHTML = window.watchView.contentDivContent;
}/*WATCH VIEWS*/
...
console.time('Build actions time');
  /*SHARED SETTING FUNCTIONS*/{
    ...
    document.querySelector('.close-menu').addEventListener('click', window.settingfs.closeMenu);
